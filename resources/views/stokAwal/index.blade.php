        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Stok Awal </h3> 
                    <a href="{{route('stokAwal.create')}}" class="btn btn-primary btn-responsive float-right">Tambah Stok Barang
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button action="{{route('stokAwal.destroy',[$d->id])}}" class="btn btn-default bg-danger">
                                                    Hapus
                                                </button>
                                                @csrf
                                            </form> 
